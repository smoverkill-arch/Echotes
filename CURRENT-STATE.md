...
- `002-note-echo-flows` tem US1, US2 e US3 implementadas no codigo: leitura de
  ecos, Reader com notas conectadas, criacao manual, bloqueio de duplicidade,
  paginacao de candidatas, remocao confirmada e continuacao atomica de nota
  por RPC `continue_note`
